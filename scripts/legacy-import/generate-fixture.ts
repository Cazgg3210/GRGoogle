...
export const FIXTURE_ROWS: Record<string, Cell[][]> = {
  Jurídico: [
    [
      'JU-01',
      'Revisar contrato de arrendamiento de oficinas',
      'Lisa de la Fuente',
      'Jurídico',
      null,
      '2026-08-05',
      ...
      0,
      'No',
      'Falta anexo de mantenimiento',
    ],
    [
      'JU-02',
      'Registrar marca ante el IMPI',
      'Lisa de La Fuente',
      'Jurídico',
      null,
      '2026-08-05',
    ...
    [
      'JU-03',
      'Actualizar política de firmas electrónicas',
      'Lisa de la Fuente',
      'Jurídico',
      null,
      '2026-08-12',
    ...
    [
      'JU-01',
      'Dictamen sobre cláusula de exclusividad cliente alfa',
      'Lisa',
      'Jurídico',
      'cliente alfa',
      '2026-08-19',
  ...
  'Ventas y Marketing': [
    [
      'VM-01',
      'Diseñar campaña digital Q4',
      'Paola Mendieta',
      'Ventas y Marketing',
      'Campaña Q4',
      excelSerial('2026-08-05'),
      32,
      'Alta',
      'En proceso',
      0,
    ...
    [
      'VM-02',
      'Actualizar organigrama en el sitio web',
      'Paola',
      'Ventas y Marketing',
      null,
      '2026-08-12',
      ...
      1,
      'No',
      'Entregado a Dirección, pendiente visto bueno',
    ],
    [
      'VM-03',
      'Cotizar agencia de video',
      null,
      'Ventas y Marketing',
      'Campaña Q4',
      '2026-08-19',
    ...
    [
      'JU-01',
      'Preparar estudio de mercado zona norte',
      'Paola Mendieta',
      'Ventas y Marketing',
      'Expansión Norte',
      '2026-08-26',
  ...
  'Operaciones y Proyectos': [
    [
      'OP-01',
      'Configurar ambiente de pruebas Plataforma Beta',
      'Rodrigo Navarro',
      'Operaciones',
      'Beta',
      '2026-08-05',
      ...
      0,
      'Sí',
      'Proyecto en pausa hasta recibir credenciales',
    ],
    [
      'OP-02',
      'Enviar carta de intención a Cliente Alfa',
      'Andrés',
      'Operaciones y Proyectos',
      'Cliente Alfa',
      '2026-08-12',
    ...
    [
      'OP-03',
      'Enviar carta de intencion al cliente Alfa',
      'Andres',
      'Operaciones y Proyectos',
      'Alfa',
      '2026-08-19',
    ...
    [
      'OP-04',
      'Migrar expedientes a Drive compartido',
      'Andres Escandon',
      'Operaciones y Proyectos',
      'Nuevo Frente Logística',
      '2026-08-19',
      34,
      'Media',
      'Completo',
  ...
  'Admin y Finanzas': [
    ...
    [
      'AF-02',
      'Renovar póliza de seguro de oficinas',
      'Hector Salgado',
      'Admin y Finanzas',
      null,
      '2026-08-05',
    ...
    [
      'AF-03',
      'Conciliar cuentas bancarias de agosto',
      'Héctor',
      'Admin y Finanzas',
      'Cierre Fiscal',
      'agosto',
  ...
  'Dirección General': [
    [
      'DG-01',
      'Preparar reporte trimestral para el consejo',
      'Lucía Ferrer',
      'Dirección General',
      null,
      '2026-08-12',
    ...
    [
      'DG-03',
      'Aprobar plan de expansión Norte',
      'Lucía Ferrer',
      'Dirección General',
      'Expansion Norte',
      '2026-08-26',
  ...
  'Captación de Capital': [
    [
      'CC-01',
      'Preparar deck para inversionistas Fondo Gamma',
      'Daniela Ortiz',
      'Captación de Capital',
      'Fondo Gamma',
      '2026-08-05',
    ...
    [
      'CC-02',
      'Agendar segunda ronda con inversionistas',
      'Daniela',
      'Captación de Capital',
      'gamma',
      '2026-08-19',
  ...
  'Servicio al Cliente': [
    [
      'SC-01',
      'Responder quejas pendientes del portal',
      'Iván Robles',
      'Servicio al Cliente',
      'Portal de Clientes',
      '2026-08-12',
  ...
  Externos: [
    [
      'EX-01',
      'Revisar deducciones fiscales de agosto',
      'Despacho Contable Ruiz',
      'Ruiz y Asociados',
      'Ricardo Ruiz',
      'Cierre Fiscal',
      '2026-08-12',
    ...
    [
      'EX-02',
      'Entregar credenciales del ambiente de pruebas',
      'Proveedor TI Nube MX',
      'Nube MX',
      'Elena Vidal',
      'Beta',
      '2026-08-05',
      ...
      'En proceso',
      0,
      'Esperan contrato de soporte',
    ],
    [
      'EX-03',
      'Escriturar terreno de Monterrey',
      'Notaría 27',
      'Notaría Pública 27',
      null,
      'Expansión Norte',
...
export function buildFixtureWorkbook(): XLSX.WorkBook {
  ...
  XLSX.utils.book_append_sheet(
    ...
    XLSX.utils.aoa_to_sheet([
      ...
      [
        'MAESTRO-1',
        'Fila calculada que NO debe importarse',
        'Nadie',
        'Jurídico',
        null,
        '2026-08-01',
...
if (isMain) {
  ...
  console.log(
    `Fixture legado escrito en ${written} (${Object.keys(FIXTURE_ROWS).length} hojas fuente, ${rows} filas incluyendo vacías)`,
  )
}
