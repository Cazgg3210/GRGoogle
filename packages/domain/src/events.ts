...
export type DomainEvent =
  ...
  | { type: 'MeetingAnalyzed'; meetingId: Id; processingRunId: Id; reviewRequired: boolean; occurredAt: Date }
  | { type: 'MeetingProcessingFailed'; meetingId: Id; errorCode: string; occurredAt: Date }
  | { type: 'ActionItemCreated'; actionItemId: Id; meetingId: Id | null; ownerUserId: Id | null; proposed: boolean; occurredAt: Date }
  | { type: 'ActionItemLinkedToMeeting'; actionItemId: Id; meetingId: Id; relation: RelationType; occurredAt: Date }
  | { type: 'ActionItemStatusChanged'; actionItemId: Id; from: ActionItemStatus; to: ActionItemStatus; byUserId: Id | null; occurredAt: Date }
  | { type: 'ActionItemReassigned'; actionItemId: Id; fromUserId: Id | null; toUserId: Id | null; byUserId: Id | null; occurredAt: Date }
  | { type: 'CompletionProposed'; actionItemId: Id; proposalId: Id; byType: 'AI' | 'USER'; occurredAt: Date }
